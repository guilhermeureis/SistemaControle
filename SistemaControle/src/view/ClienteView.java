...
public class ClienteView extends javax.swing.JFrame {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        cliente.setSexo(formatarCampos(sexo));
        ...
        if(Objects.equals(operacao, OperacoesCrud.NOVO.getOperacao())){
            try {
                ...
                //atualiza a tabela com os dados inseridos
                modelo.addRow(new Object[]{clienteC.getCodigo(cliente),nome,cpf,sexo,cliente.getDataNascimento(),fone});
                
                JOptionPane.showMessageDialog(null, "O cliente "+cliente.getNome()+" foi cadastrado com sucesso!","Sucesso",JOptionPane.INFORMATION_MESSAGE);
    ...
    private String formatarCampos(String sexo) {
